...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_5fB.pack(_x.ac_voltage, _x.dc_voltage, _x.load, _x.percentage, _x.temperature, _x.on))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.ac_voltage, _x.dc_voltage, _x.load, _x.percentage, _x.temperature, _x.on,) = _struct_5fB.unpack(str[start:end])
