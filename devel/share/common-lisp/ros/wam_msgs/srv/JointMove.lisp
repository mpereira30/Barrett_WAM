...
(cl:defmethod cl:initialize-instance :after ((m <JointMove-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointMove-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_msgs-srv:<JointMove-request> is deprecated: use wam_msgs-srv:JointMove-request instead.")))

(cl:ensure-generic-function 'joints-val :lambda-list '(m))
(cl:defmethod joints-val ((m <JointMove-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wam_msgs-srv:joints-val is deprecated.  Use wam_msgs-srv:joints instead.")
  (joints m))
...
(cl:defmethod cl:initialize-instance :after ((m <JointMove-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointMove-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_msgs-srv:<JointMove-response> is deprecated: use wam_msgs-srv:JointMove-response instead.")))
