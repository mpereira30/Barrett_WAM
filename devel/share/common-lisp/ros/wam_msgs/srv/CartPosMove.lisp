...
(cl:defmethod cl:initialize-instance :after ((m <CartPosMove-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CartPosMove-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_msgs-srv:<CartPosMove-request> is deprecated: use wam_msgs-srv:CartPosMove-request instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <CartPosMove-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wam_msgs-srv:position-val is deprecated.  Use wam_msgs-srv:position instead.")
  (position m))
...
(cl:defmethod cl:initialize-instance :after ((m <CartPosMove-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CartPosMove-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_msgs-srv:<CartPosMove-response> is deprecated: use wam_msgs-srv:CartPosMove-response instead.")))
