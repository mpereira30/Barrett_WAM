...
(cl:defmethod cl:initialize-instance :after ((m <OrtnMove-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OrtnMove-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_msgs-srv:<OrtnMove-request> is deprecated: use wam_msgs-srv:OrtnMove-request instead.")))

(cl:ensure-generic-function 'orientation-val :lambda-list '(m))
(cl:defmethod orientation-val ((m <OrtnMove-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wam_msgs-srv:orientation-val is deprecated.  Use wam_msgs-srv:orientation instead.")
  (orientation m))
...
(cl:defmethod cl:initialize-instance :after ((m <OrtnMove-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OrtnMove-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_msgs-srv:<OrtnMove-response> is deprecated: use wam_msgs-srv:OrtnMove-response instead.")))
