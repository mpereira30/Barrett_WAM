...
(cl:defmethod cl:initialize-instance :after ((m <GravityComp-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GravityComp-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_msgs-srv:<GravityComp-request> is deprecated: use wam_msgs-srv:GravityComp-request instead.")))

(cl:ensure-generic-function 'gravity-val :lambda-list '(m))
(cl:defmethod gravity-val ((m <GravityComp-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wam_msgs-srv:gravity-val is deprecated.  Use wam_msgs-srv:gravity instead.")
  (gravity m))
...
(cl:defmethod cl:initialize-instance :after ((m <GravityComp-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GravityComp-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_msgs-srv:<GravityComp-response> is deprecated: use wam_msgs-srv:GravityComp-response instead.")))
