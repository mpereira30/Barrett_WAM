...
#include <wam_msgs/LASERControl.h>
#include <wam_msgs/LEDControl.h>
...
private:
	bool led_control(wam_msgs::LEDControl::Request &, wam_msgs::LEDControl::Response &);
	bool laser_control(wam_msgs::LASERControl::Request &, wam_msgs::LASERControl::Response &);
