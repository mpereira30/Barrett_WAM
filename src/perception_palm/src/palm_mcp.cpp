...
bool ppalm_ros_wrapper::led_control(wam_msgs::LEDControl::Request &req, wam_msgs::LEDControl::Response &res){
...
bool ppalm_ros_wrapper::laser_control(wam_msgs::LASERControl::Request &req, wam_msgs::LASERControl::Response &res){
